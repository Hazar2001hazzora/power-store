...
class _RegisterState extends State<Register> {
  ...
  Future<void> register(
      var email, var name, var password, var phoneNum, var location) async {
    showDialog(
        context: context,
        builder: (context) {
    ...
    try {
      var response = await http.post(Uri.parse(Endpoints.register), body: {
        'name': name,
        'email': email,
        'password': password,
        'address': location,
